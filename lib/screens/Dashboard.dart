...
class _DashboardState extends State<Dashboard> {
  ...
  void handleDeepLink(BuildContext context, String link) {
    ...
    if (route == "discussion") {
      Navigator.push(context,
          MaterialPageRoute(builder: (context) => WhizzdomScreen(url: link)));
    }
  ...
  void addAutoStartup() async {
    ...
    String manufacturer = androidDeviceInfo.manufacturer
        .toString(); // Replace this with actual device manufacturer
  ...
  Future<void> DashboardApiFunction() async {
    try {
      ...
      var lastLocationTime =
          await PreferenceService().getString("lastLocationTime");
                                  ...
                                  children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          width:
                                              220, // Wrapping username in a Container
                                          child: Text(
                                            "$username",
                                            maxLines: 2,
                                            style: TextStyle(
