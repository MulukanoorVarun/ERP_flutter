...
class ViewVisitDetails extends StatefulWidget {
  final complaintId;
  const ViewVisitDetails({Key? key, required this.complaintId})
      : super(key: key);
  @override
...
class _ViewVisitDetailsState extends State<ViewVisitDetails> {
  ...
  Future<void> LoadVisitDetailsAPI() async {
    ...
    try {
      ...
      await UserApi.loadVisitDetailsAPI(empId, session, widget.complaintId)
          .then((data) => {
                if (data != null)
                  {
                    setState(() {
                                ...
                                child: Column(
                                  children: [
                                    Container(
                                      ...
                                      margin:
                                          EdgeInsets.fromLTRB(7.5, 7.5, 0, 0),
                                      child: Text(
                                        "Customer Details",
                                        style: TextStyle(
                                          fontSize: FontConstant.Size18,
