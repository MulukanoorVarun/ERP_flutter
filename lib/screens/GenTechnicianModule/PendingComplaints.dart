                                               ...
                                               children: [
                                                 ...
                                                 InkWell(
                                                   onTap: () async {
                                                     ...
                                                     var res = await Navigator.push(context, MaterialPageRoute(builder: (context)=>UpdateComplaint(complaint_id:  tpech_comp_list![index].complaintId!)));
                                                     if(res==true){
                                                       setState(() {
                                                         isLoading = true;
                                                         TechnicianPendingComplaints();
                                                   ...
                                                   onTap: () async {
                                                     ...
                                                     var res =  await Navigator.push(context, MaterialPageRoute(
                                                       builder: (context) => ViewVisitDetails(
                                                         complaintId:tpech_comp_list![index].complaintId,
                                                       ),
                                                     ));
                                                     if(res==true){
                                                       setState(() {
