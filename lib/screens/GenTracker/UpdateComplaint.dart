...
class UpdateComplaint extends StatefulWidget {
  final complaint_id;
  const UpdateComplaint({Key? key, required this.complaint_id})
      : super(key: key);
                    ...
                    setState(() {
                      if (data.sessionExists == 1) {
                        if (data.error == 0) {
                          ...
                          toast(
                              context, "Tag Generator before updating visit !");
                        } else if (data.error == 3) {
                          toast(
                              context, "Tag Location before updating visit !");
                        } else {
                          toast(context,
                              "Something Went Wrong, please try again later!");
                        }
