...
import '../snack_bar/safe_area_values.dart';
import '../snack_bar/tap_bounce_container.dart';
...
void OwnToast(context,inputmessage,error){
  return showTopSnackBar(
    Overlay.of(context),
      (error=="0") ? CustomSnackBar.success(message:inputmessage) : ((error=="1") ? CustomSnackBar.error(message:inputmessage):CustomSnackBar.info(message:inputmessage))
  );
}
